      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative h-[600px] md:h-[500px] w-full rounded-lg overflow-hidden border border-[#03e9f4]/30">
              {/* Placeholder for your image */}
              {/* Background Image with 50% opacity */}
  <img
    src={storyImage}
    alt="Story Background"
    className="absolute inset-0 w-[750px] h-[750px] object-cover opacity-100 mx-auto"
  />

  {/* Gradient overlay on top of the image */}
  <div className="absolute inset-0 bg-gradient-to-br from-[#03e9f4]/20 to-[#7928ca]/20"></div>
